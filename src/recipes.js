...
export const RECIPES = {
  ...
  gochujangTofu: {
    ...
    time: "45 min",
    ingredients: [
      { item: "Firm tofu, baked not fried", amount: "14 oz (397 g)", group: "legumes" },
      { item: "Broccoli", amount: "600 g", group: "vegetables" },
      { item: "Garlic", amount: "5 cloves + 1 tsp (30 g)", group: "vegetables" },
      { item: "Green onions", amount: "1-2 (22 g)", group: "vegetables" },
      ...
      { item: "Toasted sesame seeds", amount: "12 g", group: "nuts" },
      { item: "Gochujang, gochugaru, soy sauce, oyster sauce, mirin, bouillon", amount: "to taste" },
